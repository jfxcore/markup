# JFXcore.markup
Support library for FXML/2 markup. This library is only required for FXML/2 documents that use
...
# Releases
The latest release is available on [Maven Central](https://central.sonatype.com/artifact/org.jfxcore/markup/0.5.0).
...
```kotlin
dependencies {
    implementation("org.jfxcore:markup:0.5.0")
}
```
